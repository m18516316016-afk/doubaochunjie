...
export const TIMELINE_DATA: TimelineSection[] = [
  {
    ...
    items: [
      ...
      { id: 'p2-raw', title: '穿搭推荐 (原图)', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/b820130e1d6544feb07adbf49236b413~tplv-r8ubuxgbfe-image.png', subTitle: 'ORIGINAL' },
      { id: 'p2-res', title: '穿搭推荐 (效果)', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/a84fb9df233d423eaa80ca300a2e71e5~tplv-r8ubuxgbfe-image.png', subTitle: 'RESULT', badge: '图生图' },
      { id: 'p3-base', title: '基础场景图（原图）', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/47fa576efd4f4c269bc797725fa87f09~tplv-r8ubuxgbfe-image.png', subTitle: 'BASE' },
      { id: 'p3-fire', title: '增加烟花(效果)', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/fac1159b4fe943bc82adfbe1b7ae6ea3~tplv-r8ubuxgbfe-image.png', subTitle: 'FIREWORKS', badge: '图生图' },
      { id: 'p3-lantern', title: '增加灯笼(效果)', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/09c352fad6224c93be9e5e907099a4a9~tplv-r8ubuxgbfe-image.png', subTitle: 'LANTERNS', badge: '图生图' },
    ]
  },
  {
    id: 'eve-pre-gala',
    ...
    items: [
      ...
      { id: 'e3', title: '新春Plog/三宫格', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/7aa7dfb2514d44a4a5a6827c9f2f1fef~tplv-r8ubuxgbfe-image.png' },
  ...
  },
  {
    ...
    items: [
      { id: 'd1_5', title: '金币爆炸-特效', type: 'video', imageUrl: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/30eh7uhpxvbn/jinbibaozha.mp4', badge: '视频', subTitle: 'COIN EXPLOSION' },
      { id: 'd1_6', title: '新春写真（马年、红包、民俗）', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/c9967655d90e40f3815cb6666104acbc~tplv-r8ubuxgbfe-image.png', subTitle: 'PORTRAIT 2025' },
      { id: 'd1_2', title: '烟花拜年', type: 'video', imageUrl: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/30eh7uhpxvbn/12月30日.mp4', badge: '视频' },
      { id: 'd1_3', title: '鱼眼拜年', type: 'video', imageUrl: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/30eh7uhpxvbn/v0d455g10004d5acjk7og65i19u6jpf0.mp4', badge: '视频' },
      ...
      { id: 'd1_4', title: '红包雨-特效', type: 'video', imageUrl: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/30eh7uhpxvbn/hongbaoluoxia.mp4', badge: '视频' },
    ]
  },
  {
    id: 'day-2-4',
    ...
    items: [
      ...
      { id: 'd2_2', title: '新春写真（民俗）', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/9a5c54cd017b4e498bedf1caaae48c2d~tplv-r8ubuxgbfe-image.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'd6_2', title: '新春Plog/三宫格', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/545031c29fe74cdf838829b67b0e6bba~tplv-r8ubuxgbfe-image.png' },
      { id: 'd6_3', title: '新春写真（日常）', imageUrl: 'https://p9-butterfly.byteimg.com/tos-cn-i-r8ubuxgbfe/6be20acb0a2042ee914686301b8a3ae0~tplv-r8ubuxgbfe-image.png' },
